...
import { Send, CheckCircle2, Copy, RefreshCw, AlertCircle } from "lucide-react";
...
export const TelegramIntegration: React.FC<TelegramIntegrationProps> = ({ currentUser }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeCode && (
        <div className="bg-blue-50/50 p-6 rounded-[20px] border border-blue-100 shadow-sm relative overflow-hidden">
          <div className="absolute top-0 left-0 w-1 h-full bg-blue-500"></div>
          <h4 className="font-bold text-blue-900 mb-2">Your Link Code</h4>
      ...
      {error && (
        <div className="p-4 bg-red-50 text-red-700 rounded-xl border border-red-100 flex items-start gap-2 text-sm">
