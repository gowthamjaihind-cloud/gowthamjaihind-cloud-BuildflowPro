              ...
              >
                ...
                <div className="flex flex-wrap gap-6 md:gap-12 relative z-10 w-full xl:w-auto">
                  ...
                  <div className="flex-1 min-w-[140px] bg-red-50/50 p-4 md:p-6 rounded-2xl md:rounded-[32px] border border-danger/20 shadow-inner">
                    <p className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em] text-danger mb-2 md:mb-3">
                      Outstanding
                    </p>
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-start gap-2 shrink-0">
                      <span className="bg-success/12 text-success px-3 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-xl text-[8px] md:text-[9px] font-black uppercase tracking-[0.2em] border border-emerald-100/50 shadow-sm shrink-0">
                        {bill.status}
                      </span>
                      {isAdminOrOwner && (
                        <button
                    ...
                    {raBills.map((bill) => (
                      ...
                      >
                        ...
                        <td className="px-6 md:px-10 py-6 md:py-8 text-center">
                          <span className="bg-success/12 text-success px-3 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-xl text-[8px] md:text-[9px] font-black uppercase tracking-[0.2em] border border-emerald-100/50 shadow-sm">
                            {bill.status}
                          </span>
                        </td>
                        {isAdminOrOwner && (
      ...
      <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 md:gap-8 bg-panel p-4 md:p-6 rounded-[24px] md:rounded-[32px] border border-divider shadow-sm">
        <div className="flex gap-2 bg-panel/50 p-1 md:p-1.5 rounded-xl md:rounded-2xl w-full md:w-fit overflow-x-auto scrollbar-hide ring-1 ring-slate-200/50 shadow-inner">
          {(["rates", "billing"] as Tab[]).map((tab) => (
            <button
              ...
              className={`flex-1 md:flex-none px-4 md:px-8 py-2 md:py-2.5 rounded-lg md:rounded-xl text-[9px] md:text-[10px] font-black uppercase tracking-[0.15em] md:tracking-[0.2em] apple-transition whitespace-nowrap ${activeTab === tab ? "bg-surface text-primary shadow-sm ring-1 ring-divider" : "text-ink-muted hover:text-ink/80"}`}
            >
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-1.5 bg-[#C0653F] text-white px-4 md:px-5 py-2.5 md:py-3 rounded-lg md:rounded-2xl text-[9px] md:text-[10px] font-black uppercase tracking-[0.15em] hover:bg-[#A0522F] apple-transition shadow-lg shadow-primary/20"
          >
