                ...
                >
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                    <button
                      ...
                      className="bg-panel text-ink px-4 py-2 rounded-lg hover:bg-surface-dark hover:text-white apple-transition shadow-sm flex items-center justify-center gap-1.5 text-[10px] font-black uppercase tracking-[0.15em] border border-divider"
                    >
                      <Plus className="w-3.5 h-3.5" /> Add Rate
                    </button>
                    <div className={`p-1.5 text-ink-muted rounded-lg bg-panel/40 border border-divider/40 transition-transform duration-250 ${isExpanded ? "rotate-180 text-primary" : ""}`}>
                    ...
                    {rates.length === 0 ? (
                      <div className="py-12 text-center bg-surface/50 border border-dashed border-divider/60 rounded-xl">
                        ...
                        <button
                          ...
                          className="mt-3 text-primary text-[10px] font-black uppercase tracking-widest hover:underline"
                        >
            ...
            {raBillsSummary.map((bill) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 md:gap-8 relative z-10">
                  <div className="bg-surface-dark text-white p-4 md:p-6 rounded-[24px] md:rounded-[32px] shadow-2xl shadow-drab/10 group-hover:bg-primary apple-transition">
                  ...
                  <div>
                    ...
                    <p className="text-ink-muted font-bold uppercase tracking-[0.2em] text-[10px] md:text-[10px]">
                ...
                <div className="flex flex-wrap gap-6 md:gap-12 relative z-10 w-full xl:w-auto">
                  <div className="flex-1 min-w-[100px]">
                    <p className="text-[10px] md:text-[10px] font-black uppercase tracking-[0.3em] text-ink-muted mb-2 md:mb-3">
                      Gross Amount
                    </p>
                  ...
                  <div className="flex-1 min-w-[100px]">
                    ...
                    <p className="text-base md:text-2xl font-mono font-black text-success tracking-tighter leading-none">
                      ₹
                  ...
                  <div className="flex-1 min-w-[140px] bg-red-50/50 p-4 md:p-6 rounded-2xl md:rounded-[32px] border border-danger/20 shadow-inner">
                    <p className="text-[10px] md:text-[10px] font-black uppercase tracking-[0.3em] text-danger mb-2 md:mb-3">
                      Outstanding
                    </p>
                    <p className="text-xl md:text-2xl font-mono font-black text-danger tracking-tighter leading-none">
                      ₹
                ...
                {isAdminOrOwner && (
                  <button
                    ...
                    className="w-full xl:w-auto bg-surface-dark text-white px-8 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] md:text-[10px] hover:bg-[#3A4F5F] apple-transition shadow-lg shadow-drab/10 disabled:opacity-50 relative z-10 active:scale-95"
                  >
            ...
            <div className="space-y-4">
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="pr-4">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="font-black text-primary tracking-tighter text-xs md:text-sm">
                          {bill.billNumber}
                        </span>
                        <span className="font-mono text-[10px] md:text-[10px] font-black text-ink-muted">
                          {bill.billDate}
                        </span>
                      </div>
                    </div>
                    <div className="flex items-start gap-2 shrink-0">
                      <span className="bg-success/12 text-success px-3 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-xl text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] border border-emerald-100/50 shadow-sm shrink-0">
                        {bill.status}
                      </span>
                      {isAdminOrOwner && (
                        <button
                  ...
                  <div className="flex justify-between items-end mt-4 pt-4 border-t border-divider/30">
                    <div>
                      <p className="text-[10px] md:text-[10px] font-black uppercase tracking-[0.3em] text-ink-muted mb-1">
                        Gross
                      </p>
              ...
              {raBills.length > 0 && (
                <div className="bg-surface-dark rounded-[24px] p-6 text-white mt-8">
                  <p className="text-[10px] md:text-[10px] font-black uppercase tracking-[0.3em] text-white/40 mb-4 text-center">
                    Aggregated Fiscal Output
                  </p>
                  <div className="flex justify-between items-end">
                    <div>
                      <p className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] text-white/30 mb-1">
                        Total Gross
                      </p>
                    ...
                    <div className="text-right">
                      <p className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] text-white/50 mb-1">
                        Total Net
                      </p>
                ...
                <table className="w-full text-left min-w-[900px] md:min-w-[1000px]">
                  <thead>
                    <tr className="bg-surface-dark text-white/75 border-b border-white/10">
                      ...
                      <th className="px-6 md:px-10 py-4 md:py-6 text-[10px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-white/80 text-right">
                        Gross Amount
                      </th>
                      <th className="px-6 md:px-10 py-4 md:py-6 text-[10px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-white/80 text-right">
                        Net Amount
                  ...
                  <tbody className="divide-y divide-divider/40">
                    {raBills.map((bill) => (
                      ...
                      >
                        <td className="px-6 md:px-10 py-6 md:py-8 font-black text-primary tracking-tighter text-sm whitespace-nowrap">
                          {bill.billNumber}
                        </td>
                        <td className="px-6 md:px-10 py-6 md:py-8 font-mono text-[10px] md:text-[10px] font-black text-ink-muted group-hover:text-ink-muted apple-transition">
                          {bill.billDate}
                        </td>
                        ...
                        <td className="px-6 md:px-10 py-6 md:py-8 text-center">
                          <span className="bg-success/12 text-success px-3 md:px-4 py-1.5 md:py-2 rounded-lg md:rounded-xl text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] border border-emerald-100/50 shadow-sm">
                            {bill.status}
                          </span>
                        </td>
                        {isAdminOrOwner && (
                  ...
                  <tfoot className="bg-surface-dark border-t border-white/5">
                    <tr className="font-black text-sm">
                      <td
                        colSpan={3}
                        className="px-6 md:px-10 py-8 md:py-12 text-right uppercase tracking-[0.3em] md:tracking-[0.4em] text-white/20 text-[10px] md:text-[10px]"
                      >
                        Aggregated Fiscal Output
                      </td>
        ...
        <div className="flex gap-2 bg-panel/50 p-1 md:p-1.5 rounded-xl md:rounded-2xl w-full md:w-auto md:min-w-0 md:flex-1 overflow-x-auto scrollbar-hide ring-1 ring-slate-200/50 shadow-inner">
          {(["rates", "billing"] as Tab[]).map((tab) => (
            <button
              ...
              className={`flex-1 md:flex-none px-4 md:px-8 py-2 md:py-2.5 rounded-lg md:rounded-xl text-[10px] md:text-[10px] font-black uppercase tracking-[0.15em] md:tracking-[0.2em] apple-transition whitespace-nowrap ${activeTab === tab ? "bg-surface text-primary shadow-sm ring-1 ring-divider" : "text-ink-muted hover:text-ink/80"}`}
            >
            ...
            >
              ...
              >
                <div className="space-y-1.5 md:space-y-2">
                  ...
                  <select
                    required
                    className="w-full bg-panel border-2 border-transparent focus:border-primary rounded-xl md:rounded-2xl p-3 md:p-4 outline-none text-xs md:text-sm font-bold appearance-none"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  <div className="space-y-1.5 md:space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-panel border-2 border-transparent focus:border-primary rounded-xl md:rounded-2xl p-3 md:p-4 outline-none text-xs md:text-sm font-bold"
                      value={newRate.role}
                      onChange={(e) =>
