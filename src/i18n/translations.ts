...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "cpm.projectCode": "Project code (optional)",
    "cpm.projectCodePlaceholder": "e.g. RR-2026-01",
    "cpm.projectCodeHint": "Shown on exported reports instead of the internal ID. Leave blank to use the internal ID.",
    ...
    "demoTour.back": "Back",
    "demoTour.next": "Next",
    "demoTour.done": "Finish",
    "demoTour.s1.t": "Have a look round",
    "demoTour.s1.b": "This is a real project — a G+2 house in Madurai, part built. Every figure is worked out from the site's own logs. Six steps, about a minute.",
    "demoTour.s2.t": "One job, twelve views",
    "demoTour.s2.b": "The plan, the daily logs, material, labour, cost and the client's bill — all for the job you have open. Three of these do most of the work.",
    "demoTour.s3.t": "First, the plan",
    "demoTour.s3.b": "Break the job up the way you would write it on paper. Days and budget go in once, here — everything downstream is measured against it.",
    "demoTour.s4.t": "Then the site reports back",
    "demoTour.s4.b": "Progress, headcount and material, against the task they belong to. Your engineer sends this from Telegram — nothing to install on site.",
    "demoTour.s5.t": "So cost is live",
    "demoTour.s5.b": "Planned against actual on every head. Because it is built from the logs, a gap shows up the day it opens — not at month end.",
    "demoTour.s6.t": "Tamil throughout",
    "demoTour.s6.b": "Switch the whole interface to Tamil, exports included. Your site staff need not read English.",
    "land.navDemo": "Live demo",
  ...
  ta: {
    ...
    "cpm.projectCode": "செயல்திட்டக் குறியீடு (விருப்பம்)",
    "cpm.projectCodePlaceholder": "எ.கா. RR-2026-01",
    "cpm.projectCodeHint": "உள் ஐடிக்குப் பதிலாக அறிக்கைகளில் இது காட்டப்படும். காலியாக விட்டால் உள் ஐடி பயன்படும்.",
    "cpm.workspacePlaceholder": "Project Horizon",
    ...
    "demoTour.skip": "தவிர்",
    "demoTour.back": "பின்",
    "demoTour.next": "அடுத்து",
    "demoTour.done": "முடி",
    "demoTour.s1.t": "சுற்றிப் பாருங்கள்",
    "demoTour.s1.b": "இது ஒரு உண்மையான திட்டம் — மதுரையில் பகுதியளவு கட்டப்பட்ட G+2 வீடு. ஒவ்வொரு எண்ணும் தளத்தின் பதிவுகளிலிருந்து கணக்கிடப்பட்டது. ஆறு படிகள், சுமார் ஒரு நிமிடம்.",
    "demoTour.s2.t": "ஒரு பணி, பன்னிரண்டு பார்வைகள்",
    "demoTour.s2.b": "திட்டம், தினசரி பதிவுகள், பொருள், தொழிலாளர், செலவு, வாடிக்கையாளர் பில் — அனைத்தும் நீங்கள் திறந்துள்ள பணிக்கானவை. இதில் மூன்று முக்கியமானவை.",
    "demoTour.s3.t": "முதலில், திட்டம்",
    "demoTour.s3.b": "காகிதத்தில் எழுதுவது போலவே பணியைப் பிரியுங்கள். நாட்களும் பட்ஜெட்டும் ஒருமுறை இங்கே பதிவாகும் — அதற்குப் பிறகு அனைத்தும் இதை வைத்தே அளக்கப்படும்.",
    "demoTour.s4.t": "பிறகு தளம் தகவல் அளிக்கும்",
    "demoTour.s4.b": "முன்னேற்றம், ஆள் எண்ணிக்கை, பொருள் — அவை சேர்ந்த பணிக்கு எதிராகப் பதிவாகும். உங்கள் பொறியாளர் இதை டெலிகிராம் வழியாக அனுப்புவார்; தளத்தில் எதுவும் நிறுவ வேண்டியதில்லை.",
    "demoTour.s5.t": "செலவு நேரலையில்",
    "demoTour.s5.b": "ஒவ்வொரு தலைப்பிலும் திட்டமிட்டதற்கு எதிராக உண்மைச் செலவு. பதிவுகளிலிருந்தே உருவாவதால், இடைவெளி தோன்றிய அன்றே தெரியும் — மாத இறுதியில் அல்ல.",
    "demoTour.s6.t": "முழுவதும் தமிழில்",
    "demoTour.s6.b": "ஏற்றுமதிகள் உட்பட முழு இடைமுகத்தையும் தமிழுக்கு மாற்றலாம். உங்கள் தள ஊழியர்கள் ஆங்கிலம் படிக்க வேண்டியதில்லை.",
    "land.navDemo": "நேரடி டெமோ",
