    ...
    <div className="h-screen flex items-center justify-center p-6 overflow-hidden relative">
      ...
      >
        ...
        <button
          ...
          className={`w-full bg-onyx text-white py-6 rounded-3xl font-bold flex items-center justify-center gap-4 hover:bg-onyx/80 apple-transition active:scale-[0.98] shadow-2xl shadow-surface-dark/10 group text-[17px] ${isLoggingIn ? "opacity-50 cursor-not-allowed" : ""}`}
        >
          {isLoggingIn ? (
            <>
